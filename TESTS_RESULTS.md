...
> gedcom-merger@2.2.2 test:all
> npm run test:static && npm run test


> gedcom-merger@2.2.2 test:static
...
└─────────────────────────────────────────────────────────────────────────────┘
  ...
  ✅ Version 2.2.2 dans package.json
...
═══════════════════════════════════════════════════════════════════════════════
  ...
  ✅ Version 2.2.2 validée (tests statiques)

═══════════════════════════════════════════════════════════════════════════════

> gedcom-merger@2.2.2 test
> vitest run


 RUN  v1.6.1 /home/claude/gedcom-merger

 ✓ tests/parser.test.mjs  (30 tests) 12ms
 ✓ tests/conflicts.test.mjs  (51 tests) 17ms
 ...
 Test Files  4 passed (4)
   ...
   Start at  17:33:12
   Duration  2.35s (transform 170ms, setup 1ms, collect 320ms, tests 57ms, environment 1ms, prepare 3.50s)
